 ...
 * @author Nilesh
 */
public class loaderTest extends javax.swing.JFrame {

    /**
     * Creates new form loaderTest
     */
      private final WaitLayerUI layerUI = new WaitLayerUI();
    public loaderTest() {
        initComponents();
         jPanel1.add(new JLayer<JComponent>(new JScrollPane(te), layerUI));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loaderTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new loaderTest().setVisible(true);
            }
        });
    }
